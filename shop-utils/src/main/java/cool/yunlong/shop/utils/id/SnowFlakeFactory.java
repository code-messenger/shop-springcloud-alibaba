...
public class SnowFlakeFactory {
     ...
     * 则调用SnowFlake类的构造方法，并且传入默认的数据中心id和机器id，
     * 将实例化后的SnowFlake对象加入缓存，并且返回SnowFlake对象
     *
     * @return SnowFlake
     */
     ...
     * 如果数据中心id和机器id都为0，则返回默认的SnowFlake对象
     * 如果数据中心id和机器id都不为0，则返回SnowFlake对象
     *
